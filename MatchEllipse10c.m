function [ Score] = MatchEllipse10c(Is,Iel,~,Ycnt,~) 
...
%=======================================working mode===========================================================================
%Take the edge image (gradient size) of Is and gradient direction  map of both Is
...
ScoreUp=0;
  ...
  ScoreUp=ScoreUp+p(f)*Is(p(f))*abs(cos((dIs(p(f))-dIt(p(f)))));% the score value of x,y point  is increase or decrease according to how close the value of the gradient direction and image of this point the gradient difference could be between zero in which the value increase by 1 and 2pi in which the value decrease by one
...
ScoreDn=0;
  ...
  ScoreDn=ScoreDn+p(f)*Is(p(f))*abs(cos((dIs(p(f))-dIt(p(f)))));% the score value of x,y point  is increase or decrease according to how close the value of the gradient direction and image of this point the gradient difference could be between zero in which the value increase by 1 and 2pi in which the value decrease by one
